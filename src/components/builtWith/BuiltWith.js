    ...
    <div className={styles.container}>
      <div className={styles.left}>
        <div className={styles.leftTextWrapper}>
          <p className={styles.title}>Built By Swifttraderz</p>
          <h1 className={styles.subtitle1}>Swifttraderz Dashboard</h1>
      ...
      <div className={styles.right}>
        <div className={styles.text}>
          ...
          <p>Swifttraderz is based on an advanced sophisticated algorithm that allows generating unlimited binary and Minning signals which enable us to trade with most top 10 currency pairs in different time frames without limitations</p>
